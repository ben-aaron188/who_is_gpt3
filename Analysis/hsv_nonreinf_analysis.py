...
hvs_full = pd.read_csv (r'.data/hvs/nonreinforced/hvs_nonreinf_full_data_cleaned.csv')
...
hvs.to_csv('.data/hvs/nonreinforced/hvs_nonreinf_plus_values.csv', index=False)
...
corr_tab.to_csv(r'.data/hvs_descriptives/non_reinforced/corr_tab.csv', index = False)
p_values_cor_tab.to_csv(r'.data/hvs_descriptives/non_reinforced/cor_tab_p_values.csv', index = False)
corr_tab_simb.to_csv(r'.data/hvs_descriptives/non_reinforced/corr_tab_simb.csv', index = False)
...
for t in hvs_by_temp:
    ...
    corr_tab.to_csv(r'.data/hvs_descriptives/non_reinforced/corr_by_temp/corr_0.'+str(temp)+'.csv')
    temp+=1
...
overall_stats.to_csv('.data/hvs_descriptives/non_reinforced/overall_stats.csv', index=False)
...
combined_overall_stats.to_csv('.data/hvs_descriptives/non_reinforced/overall_stats_centered.csv', index=False)
...
hvs_mean_SD_by_temp.to_csv('.data/hvs_descriptives/non_reinforced/mean_SD_by_temp.csv', index=False)
...
hvs_median_by_temp.to_csv('.data/hvs_descriptives/non_reinforced/median_by_temp.csv', index=False)
...
GLM_tab = pd.DataFrame({'Coefficient':coef, 'Std Err':std_err, 'CI':CI},
                          index=values)
GLM_tab.to_csv('.data/hvs_descriptives/non_reinforced/GLM_coefficients.csv')
